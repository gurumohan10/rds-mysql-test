...
public class CloudFormationStarter implements RequestHandler<Object, Object> {
    ...
    public Object handleRequest(Object o, Context context) {
        ...
        paramsList.add(Parameter.builder().parameterKey("User").parameterValue("mohan").build());
        paramsList.add(Parameter.builder().parameterKey("Password").parameterValue("mohan").build());
        paramsList.add(Parameter.builder().parameterKey("InstanceID").parameterValue("mohandb").build());
